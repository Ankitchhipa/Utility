...
import codec.TIFFFaxDecoder;
import codec.TIFFFaxDecompressor;*/
...
public final class FilterHandlers {
    ...
    static {
        ...
        // map.put(PdfName.FL, new FilterHandlers.Filter_FLATEDECODE());
        map.put(PdfName.ASCIIHEXDECODE, new Filter_ASCIIHEXDECODE());
        //   map.put(PdfName.AHX, new FilterHandlers.Filter_ASCIIHEXDECODE());
        map.put(PdfName.ASCII85DECODE, new Filter_ASCII85DECODE());
        //   map.put(PdfName.A85, new FilterHandlers.Filter_ASCII85DECODE());

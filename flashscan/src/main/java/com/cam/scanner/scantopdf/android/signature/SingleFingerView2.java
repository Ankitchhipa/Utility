...
public class SingleFingerView2 extends LinearLayout {
    ...
    public SingleFingerView2(Context context) {
        this(context, null, 0);
    }

    public SingleFingerView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressLint("ClickableViewAccessibility")
    public SingleFingerView2(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this._1dp = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, context.getResources().getDisplayMetrics());
        this.parseAttr(context, attrs);
        View mRoot = View.inflate(context, R.layout.item_view_sign_2, null);
        addView(mRoot, -1, -1);
        mPushView = mRoot.findViewById(R.id.push_view_2);
        mView = mRoot.findViewById(R.id.view_2);
